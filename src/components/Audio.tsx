...
import PitchDetectorWorkletProcessor from "worklet-loader!worklets/pitch-detector-processor.worklet.ts";
...
import VocalTubeProcessor from "worklet-loader!worklets/vocal-tube/vocal-tube-processor.worklet.ts";
  ...
  useEffect(() => {
    const awaitAudioWorkletProcessors = async (context: AudioContext) => {
      ...
      await Promise.all([
        ...
        context.audioWorklet.addModule(VocalTubeProcessor),
      ]);
      setReady(true);
    };
